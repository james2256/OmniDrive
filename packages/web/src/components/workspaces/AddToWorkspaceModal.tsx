          ...
          <div className="overflow-y-auto flex-1 space-y-1.5 max-h-[50vh]">
            {folders.map(folder => (
              ...
              <button
                ...
                className={`w-full flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-left transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 ${selectedId === folder.id ? 'bg-blue-100' : 'hover:bg-slate-50'}`}
              >
