  ...
  return (
    <PublicPageLayout title="Privacy Policy">
      ...
      <section className="space-y-4">
        ...
        <h3 className="font-medium text-gray-900">2.2 Google user data</h3>
        <p>
        ...
        <h3 className="font-medium text-gray-900">2.3 Usage data</h3>
        <p>
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold text-gray-900">6. Data Retention and Deletion</h2>
        <p>
