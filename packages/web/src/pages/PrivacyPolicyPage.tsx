  ...
  return (
    <PublicPageLayout title="Privacy Policy">
      ...
      <section className="space-y-4">
        ...
        <p>
          OmniDrive&apos;s use and transfer of information received from Google APIs adheres to the{' '}
          <a
        ...
        <ul className="list-disc space-y-1 pl-6">
          <li>
            We only use Google user data to provide and improve user-facing features of OmniDrive
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          . You can also disconnect individual drives from OmniDrive Settings.
        </p>
      </section>
