  ...
  return (
    <div className="min-h-[100dvh] bg-surface">
      <header className="border-b border-gray-200 bg-white">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4 sm:px-6">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-semibold text-gray-900">AzaDrive</span>
          </div>
          <Link
            to="/login"
      ...
      <main>
        <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-24">
          <div className="mx-auto max-w-2xl text-center">
            <img src="/logo.png?v=2" alt="AzaDrive" className="mx-auto mb-6 h-20 w-20 object-contain" />
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
              Unified multi-Google Drive storage gateway
            </h1>
            <p className="mt-6 text-lg text-gray-600">
              AzaDrive lets you connect multiple Google Drive accounts, manage files in team
        ...
        <section className="border-t border-gray-200 bg-white">
          <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
            <h2 className="mb-10 text-center text-2xl font-semibold text-gray-900">Features</h2>
      ...
      <footer className="border-t border-gray-200 bg-white">
        <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-4 px-4 py-6 text-sm text-gray-500 sm:px-6">
          <p>© {new Date().getFullYear()} AzaDrive</p>
          <nav className="flex flex-wrap gap-4">
            <Link to="/privacy" className="hover:text-primary">Privacy Policy</Link>
            <Link to="/terms" className="hover:text-primary">Terms of Service</Link>
            <a href="mailto:support@azadrive.my.id" className="hover:text-primary">Contact</a>
          </nav>
        </div>
      </footer>
    </div>
