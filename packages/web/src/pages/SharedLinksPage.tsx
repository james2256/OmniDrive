    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto w-full">
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-16 text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-800 mb-2">No active shared links</h3>
          ...
          {links.map((link) => (
            ...
            >
              <div className="p-5 border-b border-gray-100 flex-1">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3 overflow-hidden">
                    ...
                    <div className="min-w-0">
                      <h3 className="text-gray-900 font-semibold truncate text-lg" title={link.targetName || link.targetId}>
                ...
                <div className="flex items-center gap-4 py-3 px-4 bg-gray-50 rounded-xl mt-4">
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    <Eye size={16} className="text-gray-400" />
                    <span className="font-medium">{link.viewCount}</span>
                    <span className="text-gray-400 text-xs uppercase tracking-wider">Views</span>
                  </div>
                  <div className="w-px h-8 bg-gray-200"></div>
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    <Download size={16} className="text-gray-400" />
                    <span className="font-medium">{link.downloadCount}</span>
                    <span className="text-gray-400 text-xs uppercase tracking-wider">DLs</span>
                  </div>
                </div>
              </div>
              ...
              <div className="px-5 py-4 bg-gray-50 flex items-center justify-between gap-3">
                <button
                  ...
                  className="flex items-center justify-center gap-2 flex-1 py-2 px-4 rounded-lg bg-white border border-gray-200 text-gray-700 font-medium text-sm hover:bg-gray-50 hover:text-blue-600 hover:border-blue-200 transition-colors"
                >
                  {copiedId === link.id ? (
                    <>
